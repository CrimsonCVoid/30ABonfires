        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <AnimateOnScroll animation="fade-right"><div>
              <h2 className="text-3xl sm:text-4xl font-bold text-ash-100 mb-8 uppercase tracking-wide">
                Send Us a Message
              </h2>
            ...
            <AnimateOnScroll animation="fade-left" delay={200}><div>
              ...
              <div className="space-y-8 mb-10">
                <div>
                  <h3 className="font-bold text-ash-100 mb-1 uppercase tracking-wider text-sm text-fire-400">Phone</h3>
                  <a
                    href={`tel:${siteConfig.phone.replace(/\D/g, "")}`}
                    className="text-ash-200/80 hover:text-fire-400 transition-colors text-2xl font-light"
                  >
                    {siteConfig.phone}
                  </a>
                </div>
                <div>
                  <h3 className="font-bold text-ash-100 mb-1 uppercase tracking-wider text-sm text-fire-400">Email</h3>
                  <a
                    href={`mailto:${siteConfig.email}`}
                    className="text-ash-200/80 hover:text-fire-400 transition-colors text-lg font-light"
                  >
                    {siteConfig.email}
                  </a>
                </div>
                <div>
                  <h3 className="font-bold text-ash-100 mb-1 uppercase tracking-wider text-sm text-fire-400">Address</h3>
                  <address className="not-italic text-ash-200/60 font-light">
                ...
                <div>
                  <h3 className="font-bold text-ash-100 mb-1 uppercase tracking-wider text-sm text-fire-400">Hours</h3>
                  <p className="text-ash-200/60 font-light">{siteConfig.hours}</p>
                </div>
                <div>
                  <h3 className="font-bold text-ash-100 mb-1 uppercase tracking-wider text-sm text-fire-400">
                    Service Area
                  </h3>
                  <p className="text-ash-200/60 font-light">{siteConfig.serviceArea}</p>
                </div>
              </div>
              ...
              <div className="glass-card rounded-xl p-8">
                ...
                <p className="text-ash-200/60 mb-6 font-light">
              ...
              <div className="mt-10">
                <h3 className="text-sm font-bold text-fire-400 mb-4 uppercase tracking-[0.2em]">
                  Follow Us
                </h3>
                <div className="flex gap-6">
                  <a
                    ...
                    className="text-ash-200/70 hover:text-fire-400 font-medium transition-colors text-sm uppercase tracking-wider"
